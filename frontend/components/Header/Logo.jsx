...
export default function Logo({ backgroundPrimary, backgroundSecondary }) {
  return (
    <Container
      href="/"
    ...
    >
      <svg
        ...
        viewBox="0 0 2571 1077.6"
        width="152px"
        height="64px"
      >
        <path
          d="M1075.5,240.1c39.3-35.1,175.1,24.8,98.8,310.3c-76.3,285.5,198,234.1,211,135.6s-147.7-155.3-146.1-272.2
	...
	C1116,898.1,1097,868,1039,779.7c-101.4-154.6,33.8-195.4,70.9-327.2C1148.2,316.6,1014.7,294.2,1075.5,240.1"
        />
        <path
          d="M2267.8,581.1c0-15.8,7.1-30,18.3-40.5c12.8-14.1,31.1-23,51.6-23c82.9,0,203.8-7.1,143.3-134.9
	...
	"
        />
        <path
          d="M555.7,769.7c-115.6-132-124.7-264.1-74.5-379.4C623.8,62.8,497.1,0,367.1,0C317,0,205.3,19.2,205.3,183.8
	...
	C171.3,808,162.2,906,122.2,906z"
        />
        <path
          d="M1086.7,423.6c-0.4-169-207.7-202-334.3-177.7c-109,20.9-263.9,102.3-269.2,256.9
	...
	C935.5,464,883.7,519,832.8,543.2z"
        />
        <path
          d="M1856.5,683c-51.3-22.8-91.2-44.8-88.2-115.6c2.4-55.4,72.5-99.3,117.8-61.2c25.3,21.3,25.1,33,36.5,56.2
